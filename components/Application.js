...
export default function ApprovalModal({ onClose }) {
  ...
  const letterCount = message.length; // Added to resolve the issue
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-lg w-full max-w-[600px] p-6 relative">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="absolute right-24 top-[25rem] text-[10px] text-gray-500">{letterCount} out of 250 letters</p>
            </div>
